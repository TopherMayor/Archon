...
def register_project_tools(mcp: FastMCP):
    ...
    async def manage_task(
        ...
        description: str = "",
        assignee: str = "User",
        agent_name: str = None, # Added agent_name
        task_order: int = 0,
        feature: str = None,
        ...
        try:
            ...
            if action == "create":
                ...
                # Get agent name from client_names mapping
                from ..api_routes.socketio_handlers import client_names
                agent_name = client_names.get(ctx.sid, "Unknown Agent")
